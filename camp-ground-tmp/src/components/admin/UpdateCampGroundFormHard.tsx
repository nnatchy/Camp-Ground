...
import { CampItem } from "interfaces"
import { useState, useEffect, FormEvent } from "react"


export default async function UpdateCampgroundForm({campJson}: {campJson: Object}) {
    ...
    // useEffect(() => {
    //     // Fetch selected campground's data when selectedCampground changes
    //     const fetchSelectedCampground = async () => {
    //         if (selectedCampground) {
    //             // Find the selected campground's data from the stored campgrounds
    //             const selectedCampgroundData = campgrounds.data.find((camp: CampItem) => camp.id === selectedCampground);

    //             if (selectedCampgroundData) {
    //                 // Update form fields with existing values for the selected campground
    //                 setName(selectedCampgroundData.name);
    //                 setAddress(selectedCampgroundData.address);
    //                 setDistrict(selectedCampgroundData.district);
    //                 setProvince(selectedCampgroundData.province);
    //                 setPostalCode(selectedCampgroundData.postalCode);
    //                 setTel(selectedCampgroundData.tel);
    //                 setPicture(selectedCampgroundData.picture);
    //             }
    //         }
    //     };
    ...
    // const updateCampground = async (updateCampground: FormEvent<HTMLFormElement>) => {
    //     updateCampground.preventDefault();
    // }
